...
import ProductDetailsPage from "./ukAnalytics/ProductDetailsPage";
import ProductTrafficPage from "./ukAnalytics/ProductTrafficPage";
import { createUkAnalyticsState, type UkAnalyticsState, type UkDataSnapshot, type UkDataSourceKey, type UkMallOverviewData, type UkParsedImport, type UkProductDetailsData, type UkProductTrafficBreakdownData, type UkProductTrafficData, type UkStoreBusinessData, type UkStoreKeywordsData, ukSourceLabels } from "./ukAnalytics/types";
...
const sourceGroups: Array<{ title: string; sources: UkDataSourceKey[] }> = [
  ...
  { title: "商品数据分析", sources: ["product-details", "product-traffic", "product-traffic-breakdown"] },
];
